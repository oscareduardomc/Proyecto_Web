...
<form id="frm-detalle_venta" action="?c=detalle_venta&a=Editar" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="NumeroFactura" value="<?php echo $prod->NumeroFactura; ?>" class="form-control" placeholder="N° Factura" data-validacion-tipo="requerido|min:100" required/>
    </div>
