...
require_once 'model/ventas_constancia.php';

class Ventas_ConstanciaController{

    private $model;

    //Creación del modelo
    public function __CONSTRUCT(){
        $this->model = new ventas_constancia();
    }

    //Llamado plantilla principal
    public function Index(){
        require_once 'view/header.php';
        require_once 'view/ventas_constancia/ventas_constancia.php';
        require_once 'view/footer.php';
    }

    //Llamado a la vista proveedor-editar
    public function Crud(){
        $prod = new ventas_constancia();
    ...
    public function Nuevo(){
        ...
        //Llamado de las vistas.
        require_once 'view/header.php';
        require_once 'view/ventas_constancia/ventas_constancia-nuevo.php';
        require_once 'view/footer.php';
    }
    ...
    public function Guardar(){
        ...
        $prod->numero_constancia = $_REQUEST['numero_constancia'];
