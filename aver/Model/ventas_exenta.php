...
class ventas_exenta
{
	...
	public function Listar()
	{
		try
		{
			...
			$stm = $this->pdo->prepare("SELECT * FROM ventas_exenta");
	...
	public function Obtener($numero_factura)
	{
		try
		{
			...
			$stm = $this->pdo->prepare("SELECT * FROM ventas_exenta WHERE numero_factura = ?");
	...
	public function Registrar(ventas_exenta $data)
	{
		try
		{
			//Sentencia SQL.
			$sql = "insert into ventas_exenta values (?,?);";
