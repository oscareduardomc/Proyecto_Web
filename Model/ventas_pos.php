...
class ventas_pos
{
	...
	public function Listar()
	{
		try
		{
			...
			$stm = $this->pdo->prepare("SELECT * FROM ventas_pos");
	...
	public function Obtener($idregistro)
	{
		try
		{
			...
			$stm = $this->pdo->prepare("SELECT * FROM ventas_pos WHERE idregistro = ?");
	...
	public function Registrar(ventas_pos $data)
	{
		try
		{
			//Sentencia SQL.
			$sql = "insert into ventas_pos (idventa, idpos, referencia, valor) values 
            (?,?,?,?);";
	...
	public function Eliminar($idregistro)
	{
		try
		{
			...
			//la clausula Where.
			$stm = $this->pdo
			            ->prepare("DELETE FROM ventas_pos WHERE idregistro = ?");
